...
namespace Player.Movement
{
    ...
    public class SlideState : PlayerState
    {
        ...
        public override void Enter()
        {
            ...
            _lastVelocity = c.motor.Velocity;
        }
        public override void BeforeCharacterUpdate(float deltaTime)
        {
        ...
        {
            c.RefreshSlideCayoteTimer();
            var speed = c.motor.BaseVelocity.magnitude;
    ...
    {
        private CapsuleCastSensor _wallRunSensor;
        ...
        public WallRunState(PlayerCharacterMover character) : base(character)
        {
            ...
            _wallRunSensor = new CapsuleCastSensor(c.transform);
            ...
            _wallRunSensor.SetRadius(c.motor.Capsule.radius)
                        .SetHeight(c.motor.Capsule.height);
        }
        public override void Enter()
        {
            c.SetStandDemensions();
        ...
        public override void UpdateVelocity(ref Vector3 currentVelocity, float deltaTime)
        {
            ...
            if (c._requestJump || c.motor.GroundingStatus.IsStableOnGround)
            {
                if (c._requestJump) // Прыжок от стены
                {
                    ...
                    currentVelocity += (
                        c._wallNormal * c.s.Wall_JumpForcesRatio.x +
                        c.motor.CharacterUp * c.s.Wall_JumpForcesRatio.y +
                        Vector3.ProjectOnPlane(c._requestMovement, c.defaultUp).normalized * c.s.Wall_JumpForcesRatio.z)
                        .normalized * c.s.Wall_JumpSpeed;
                    c.RefreshSustainJump();
                    c.EnterToAnotherState();
                    c._requestJump = false;
                    c.CharacterJumpedInvoke();
    ...
    public class LedgeGrabState : PlayerState
    {
        ...
        public LedgeGrabState(PlayerCharacterMover c) : base(c)
        {
            ...
            {
                _sensors
                    .AddOrSetSensor(LedgeGrabSensors.Forward,
                ...
                .AddOrSetSensor(LedgeGrabSensors.Up,
                new RaycastSensorSettings
                {
                ...
                .AddOrSetSensor(LedgeGrabSensors.FromUpToforward,
                new RaycastSensorSettings
                {
                ...
                .AddOrSetSensor(LedgeGrabSensors.FromForwardUpToDown,
                new RaycastSensorSettings
                {
