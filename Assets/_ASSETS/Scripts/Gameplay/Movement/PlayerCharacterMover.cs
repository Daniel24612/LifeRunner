...
namespace Player.Movement
{
    public partial class PlayerCharacterMover : MonoBehaviour, ICharacterController
    {
        ...
        [Inject] internal GameplayInputReader _inputReader;
        [Header("Settings")]
        ...
        public event Action CharacterJumped;
        internal void CharacterJumpedInvoke() => CharacterJumped?.Invoke();
        #endregion
        public void Initialize(GameplayInputReader inputReader)
        {
