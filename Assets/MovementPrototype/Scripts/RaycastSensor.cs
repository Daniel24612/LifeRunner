...
public class MutiRS
{
    ...
    private Dictionary<string, RSInfo> sensorInfos = new Dictionary<string, RSInfo>();
    public MutiRS(Transform playerTransform)
    {
        sensor = new RaycastSensor(playerTransform);
    }
    public void UpdateAllSensors()
    {
        foreach (var key in sensorInfos.Keys)
        {
            UpdateConcreteSensor(key);
        }
    }
    public void UpdateConcreteSensor(string sensorName)
    {
    ...
    public void AddSensor(string sensorName, RaycastSensorSettings settings)
    {
    ...
    public RSInfo GetSensorInfo(string sensorName)
    {
        if (sensorInfos.ContainsKey(sensorName))
